...
const optionsCities = [
    ...
    {value: "Акмолинская область (все районы и города)", label: "Акмолинская область (все районы и города)"},
    {value: "Актюбинская область (все районы и города)", label: "Актюбинская область (все районы и города)"},
    {value: "Алматинская (все районы и города)", label: "Алматинская (все районы и города)"},
    {
    ...
    {value: "Астана", label: "Астана"},
    {value: "Шымкент", label: "Шымкент"},
    {value: "Жамбылская область (все районы и города)", label: "Жамбылская область (все районы и города)"},
    {
    ...
    {value: "Атырауская область (все районы и города)", label: "Атырауская область (все районы и города)"},
    {value: "Алматы", label: "Алматы"},
...
const optionInstitutionType = [
    ...
    {value: "университет (бакалавриат/магистратура)", label: "университет (бакалавриат/магистратура)"},
    {value: "предприятие корпоративного университета", label: "предприятие корпоративного университета"},
    {value: "другое", label: "другое"},
]
const optionsInstitution = [
    {value: "Карагандинский технический университет", label: "Карагандинский технический университет"},
    {value: "Карагандинский университет", label: "Карагандинский университет"},
    {value: "Академия Болашак", label: "Академия Болашак"},
    {value: "Карагандинский экономический университет", label: "Карагандинский экономический университет"},
...
const optionsFormStudy = [
    ...
    {value: "очная (для поступающих в КИТ)", label: "очная (для поступающих в КИТ)"},
    {value: "заочная (для поступающих в КИТ)", label: "заочная (для поступающих в КИТ)"},
]
const optionsEducationProgram = [
    ...
    {value: "В044 Менеджмент и управление", label: "В044 Менеджмент и управление"},
    {value: "В045 Аудит и налогообложение", label: "В045 Аудит и налогообложение"},
    {
    ...
    {value: "В050 Биологические и смежные науки", label: "В050 Биологические и смежные науки"},
    {value: "В057 Информационные технологии", label: "В057 Информационные технологии"},
    {value: "В058 Информационная безопасность", label: "В058 Информационная безопасность"},
    {
        value: "В059 Коммуникации и коммуникационные технологии",
        label: "В059 Коммуникации и коммуникационные технологии"
    },
    {value: "В060 Химическая инженерия и процессы", label: "В060 Химическая инженерия и процессы"},
    {value: "В061 Материаловедение и технологии", label: "В061 Материаловедение и технологии"},
    {value: "В062 Электротехника и энергетика", label: "В062 Электротехника и энергетика"},
    {value: "В063 Электротехника и автоматизация", label: "В063 Электротехника и автоматизация"},
    {value: "В064 Механика и металлообработкая", label: "В064 Механика и металлообработка"},
    {value: "В065 Автотранспортные средства", label: "В065 Автотранспортные средства"},
    {value: "В073 Архитектура", label: "В073 Архитектура"},
    {
        value: "В074 Градостроительство, строительные работы и гражданское строительство",
        label: "В074 Градостроительство, строительные работы и гражданское строительство"
    },
    {value: "В075 Кадастр и землеустройство", label: "В075 Кадастр и землеустройство"},
    {
    ...
    {value: "В094 Санитарно-профилактические мероприятия", label: "В094 Санитарно-профилактические мероприятия"},
...
const optionsManager = [
    ...
    {value: "ИТБ", label: "ИТБ"},
    {value: "ИЯ", label: "ИЯ"},
    {value: "КИТ (Колледж инновационных технологий)", label: "КИТ (Колледж инновационных технологий)"},
